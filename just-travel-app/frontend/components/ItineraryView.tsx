...
export function ItineraryView({ itinerary, summary }: ItineraryProps) {
    ...
    return (
        <div className="space-y-6 mt-4 animate-slide-up">
            {/* Summary Card */}
            <div className="card-brutal bg-brutal-white border-brutal-black">
                <h3 className="text-2xl font-mono font-bold mb-4 bg-brutal-yellow inline-block px-2 border-2 border-brutal-black">
                    TRIP SUMMARY
                </h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="p-2 border-2 border-brutal-black bg-brutal-orange text-center">
                        <span className="block text-2xl font-bold">Many</span>
            ...
            <div className="card-brutal bg-brutal-white">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-2 border-b-4 border-brutal-black pb-4">
                    ...
                    <div className="badge-brutal bg-brutal-purple text-sm transform -rotate-2">
                        {currentDay.theme}
                    </div>
                </div>
                                ...
                                <div className="flex gap-2 mt-2">
                                    ...
                                    {slot.activity.price_level !== undefined && (
                                        <span className="text-[10px] uppercase font-bold border border-black px-1 text-green-700">
                                            {Array(slot.activity.price_level + 1).fill('$').join('')}
                                        </span>
                                    )}
                                </div>
                            </div>
                ...
                {/* Day Footer */}
                <div className="mt-6 pt-4 border-t-4 border-brutal-black flex justify-between items-center bg-gray-50 p-4 -mb-8 -mx-8">
