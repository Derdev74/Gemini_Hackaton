...
export default function NavHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-black/60 backdrop-blur-3xl border-b border-white/10">
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <a href="/" className="no-underline">
            <h1 className="text-2xl md:text-3xl font-mono font-bold tracking-tight">
              <span className="text-brutal-orange">JUST</span>
          ...
          <div className="hidden md:flex items-center gap-6">
            <a href="#features" className="font-mono font-bold uppercase text-sm text-white/70 hover:text-brutal-orange no-underline transition-colors">
              Features
            </a>
          ...
          {/* Hamburger */}
          <button
            className="md:hidden p-2 border border-white/20 bg-black/40 rounded-xl backdrop-blur-xl"
        ...
        {mobileOpen && (
          <div className="md:hidden mt-4 flex flex-col gap-3 border-t border-white/10 pt-4">
            <a href="#features" onClick={() => setMobileOpen(false)} className="font-mono font-bold uppercase text-sm text-white/70 hover:text-brutal-orange no-underline">
              Features
            </a>
